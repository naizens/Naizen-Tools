...
const CREDITS: { category: string; items: { name: string; desc: string; url: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'node-window-manager', desc: 'Window focus & management',    url: 'https://github.com/nicholasstephan/node-window-manager' },
      { name: 'electron-updater',    desc: 'Auto-update delivery',         url: 'https://github.com/electron-userland/electron-builder' },
      { name: 'electron-builder',    desc: 'App packaging & distribution', url: 'https://github.com/electron-userland/electron-builder' },
